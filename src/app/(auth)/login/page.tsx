      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Biltwood Powder Coating Operations Management
          </p>
        </div>

        <div className="mt-8 space-y-6">
          {message && (
            <div className={`p-3 rounded ${message.includes('Check your email') ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
              {message}
            </div>
          )}
